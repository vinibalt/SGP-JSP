							...
							<div class="">
								<div class="main-menu-header">
									<c:if test="${ userInfos.fotoUser != null}">
										<img class="img-80 img-radius" src="${ userInfos.fotoUser }"
									...
									<div class="user-details">
										<span id="more-details">${ userInfos.nome }<i
								...
								<div class="main-menu-content">
									<ul>
										<li class="more-details"><a href="<%= request.getContextPath() %>/principal/view-profile.jsp"><i
							...
							<ul class="pcoded-item pcoded-left-item">
								...
								<li class="pcoded-hasmenu"><a href="javascript:void(0)"
									...
									<ul class="pcoded-submenu">
										<c:if test="${ userInfos.admin == 1 }">
										<li class=" "><a href="<%= request.getContextPath() %>/principal/usuario-cadastro.jsp"
											class="waves-effect waves-dark"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext" data-i18n="nav.basic-components.alert">Cadastro</span>
												<span class="pcoded-mcaret"></span>
										</a></li></c:if>
										<li class=" "><a href="<%= request.getContextPath() %>/principal/consultar-usuario.jsp"
											class="waves-effect waves-dark"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.basic-components.breadcrumbs">Consultar Usuário</span>
												<span class="pcoded-mcaret"></span>
										</a></li>
